...
def play_game():
    # play = True
    # while play is True:
        file = open("test-word.txt")  # Open the file
        word = file.read().upper()  # read the file and make it a string that is uppercase
        word  = word.replace("\n", "")  # erase the \n
...
{results}
""")
            print(f"You've guessed{guessedLetters}")
            playerLetter = input(f"You have {guesses} incorrect guesses left. What letter do you guess?").upper()
            print("_____________________________________________")
# ---------- HANDLE ERRORS --------------- #
            if playerLetter.isdigit():
                print("Only letters are in this word!")
                continue
            if playerLetter in string.punctuation:
                print("Only letters are in this word!")
                continue
            if playerLetter == " ":
                print("Only letters are in this word!")
